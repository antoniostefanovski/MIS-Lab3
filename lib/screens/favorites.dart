                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              IconButton(onPressed: () => { onFavoriteClicked(jokeData) }, icon: Icon(jokeData.isFavourite ? Icons.favorite : Icons.favorite_border_outlined), color: jokeData.isFavourite ? Colors.red : Colors.grey)
                            ],
                          ),
